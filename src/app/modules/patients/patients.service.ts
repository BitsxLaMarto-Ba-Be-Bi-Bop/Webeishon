...
export class PatientsService {
    ...
    treatmentValues = signal([
        ...
        { label: 'Prednisone', value: 'Pirfenidone' },
        { label: 'MMF', value: 'Pirfenidone' },
        { label: 'Rituximab', value: 'Pirfenidone' },
        { label: 'Tacrolimus', value: 'Pirfenidone' },
        { label: 'Nintedanib', value: 'Pirfenidone' },
        { label: 'No Data', value: 'No Data' },
        { label: 'RCT 1305-0012', value: 'RCT 1305-0012' },
        { label: 'MMF (3)', value: 'MMF (3)' },
        { label: 'Azathioprine', value: 'Pirfenidone' },
        { label: 'Autotaxin Inhibitor', value: 'Pirfenidone' },
        { label: 'Prednisone (2)', value: 'Pirfenidone' },
        { label: 'NAC (2)', value: 'Pirfenidone' },
        { label: 'Methotrexate', value: 'Pirfenidone' },
        { label: 'Toxcilizumab', value: 'Pirfenidone' },
        { label: 'Adalimumab', value: 'Pirfenidone' },
        { label: 'Etanercept', value: 'Pirfenidone' },
        { label: 'Leflunomide', value: 'Pirfenidone' },
        { label: 'Lebrikizumab', value: 'Pirfenidone' },
        { label: 'Abatacept', value: 'Pirfenidone' },
        { label: 'Pembrolizumab', value: 'Pirfenidone' },
        { label: 'Pemetrexed', value: 'Pirfenidone' },
        { label: 'Nintedanib (2)', value: 'Pirfenidone' },
        { label: 'NAC', value: 'Pirfenidone' },
        { label: 'G-CSF', value: 'Pirfenidone' },
        { label: 'Sulfasalazine', value: 'Pirfenidone' },
        { label: 'Eculizumab', value: 'Pirfenidone' },
        { label: 'Poor tolerance', value: 'Pirfenidone' },
    ]);
